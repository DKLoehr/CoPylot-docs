...
\begin{python}
$\gtlet$ $\tfreshval_1$ = $\gtdef$($\tfreshval_2$) { $\osFunc{Convert\_func\_body}$($\psuite$) }
...
\begin{mathpar}
  \translationRule{Function Value}{
    \gtfun (\pexpr_1, \ldots, \pexpr_n) \gtcolon \psuite
  }{
    \left<
    \usebox{\lamiaFuncBox}\hspace{140pt},
    \tfreshmem
    \right>
  }{
    % No premises
...
\begin{definition}[Python\_assign]\ \\
