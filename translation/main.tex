...
% \begin{python}
% $\gtlet$ $\tfreshval_1$ = $\osFunc{Convert\_class\_body}$($\psuite$, ($\pvariable_1, \ldots, \pvariable_n$))
% $\gtlet$ $\tfreshmem$ = alloc
% $\gtstore$ $\tfreshmem$ $\tfreshval_1$
% \end{python}
% \end{lrbox}
...
%     \gtclass (\pvariable_1, \ldots, \pvariable_n) \gtcolon \psuite
%   }{
%     \left<
%     \usebox{\lamiaClassBox}\hspace{190pt},
%     \tfreshmem
%     \right>
%   }{
%     % No premises
