...
$\tsubsuite{\pexpr_2}$
$\tsubsuite{\pexpr_1}$
$\tsubvar{\pexpr_1}$.__setattr__($s$, $\tsubvar{\pexpr_2}$)
\end{python}
\end{lrbox}
...
\begin{python}
$\tsubsuite{\pexpr}$
$\tfreshvar$ = $\star$bool($\tsubvar{\pexpr}$)
while $\tfreshvar$:
  $\meaningof{\psuite_1}$
  $\tsubsuite{\pexpr}$
  $\tfreshvar$ = $\star$bool($\tsubvar{\pexpr}$)
...
\begin{mathpar}
  \translationRule{Unary Operation (not)}{
    ...
    \left<\usebox{\notBox}\hspace{20pt}, \gtnot (\star\gtbool(\tsubvar{\pexpr}))\right>
  }{
  }
\end{mathpar}
...
\begin{mathpar}
  \translationRule{Unary Operation (+)}{
    ...
    \left<\usebox{\uplusBox}\hspace{20pt}, \tsubvar{\pexpr}.\mathtt{\_\_pos\_\_}() \right>
  }{
  }
\end{mathpar}
...
\begin{mathpar}
  \translationRule{Unary Operation (-)}{
    ...
    \left<\usebox{\usubBox}\hspace{20pt}, \tsubvar{\pexpr}.\mathtt{\_\_neg\_\_}() \right>
  }{
  }
\end{mathpar}
