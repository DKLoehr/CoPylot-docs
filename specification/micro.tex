      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{Advance}{
                  ...
                  \olstack \listConcat [\osMC{Advance}] \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
                  \olstack \listConcat \omstack, [\osLR{\opscope, \oglbl''}] \listConcat \ostack, \oheap
              }
              ...
              \relationRule{Push \olbl}{
                  ...
                  \olstack \listConcat [\opscope, \osMC{Push} \;\olbl] \listConcat \omstack, \ostack, \oheap \osTransition
                  \olstack \listConcat \omstack, [\osLR{\opscope', \olbl}] \listConcat \ostack, \oheap'
              }
              ...
              \relationRule{Look up \ovariable \,(bound)}{
                  ...
                  \olstack \listConcat [\ovariable, \osMC{LookUp}] \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
                  \olstack \listConcat [\omem] \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
              }
          ...
          \begin{figure}\center
              ...
              \relationRule{Raise \,(no exception label)}{
                  ...
                  \olstack \listConcat [\osMC{Raise}] \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
                  \olstack \listConcat [\osMC{Pop}, \osMC{Raise}] \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
              }
              ...
              \relationRule{Goto \olbl}{
                  ...
                  \olstack \listConcat [\osMC{Goto}\;\olbl] \listConcat \omstack, [\osLR{\opscope, \olbl'}] \listConcat \ostack, \oheap \osTransition
                  \olstack \listConcat \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
              }
      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{Assign \ovalue \! to \ovariable}{
                  ...
                  \olstack \listConcat [\ovalue, \ovariable, \osMC{Assign}] \listConcat \omstack, \ostack, \oheap \osTransition
                  \olstack \listConcat \omstack' \listConcat \omstack, \ostack, \oheap
              }
      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{End of Function}{
                  ...
                  [\;], [\osLR{\opscope, \osplat}, \ostackframe] \listConcat \ostack, \oheap \osTransition
                  \omstack, [\osLR{\opscope, \osplat}, \ostackframe] \listConcat \ostack, \oheap
              }

              \tnote{$\omem_{\osnone}$ is a memory location reserved for \osnone.}

              \relationRule{End of Program}{
                  \ostack = [\osLR{\opscope, \osplat}] \\
                  \omstack = [\osMC{Pop}]
              }{
