      ...
      \begin{figure}\center
          ...
          \begin{figure}\center
              ...
              \relationRule{Call function}{
                  \oheap[\omem_0] = \osLR{ \opscope,\okw{def}(\ovariable_1, \ldots, \ovariable_2) \ofuncarr \oprogram } \\
                  \omstack' = [\osMC{Push}\;\oprogram, omem_1, \ovariable_1, \osMC{Bind}, \ldots, omem_1, \ovariable_1, \osMC{Bind}]
              }{
