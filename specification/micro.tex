  ...
  \subsection{Micro-Instruction Rules}
        ...
        \begin{mathpar}
          \relationRule{Look up \ovariable}{
              \omstack' = [\opscope, \osMC{Get}, \ovariable, \osMC{Retrieve'}]
          }{
              \osInStack{\ovariable, \osMC{LookUp}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
        ...
        \begin{mathpar}
          \relationRule{Retrieve' from \obinding \,(locally bound)}{
              \omem = \ovalue[\ovariable] \\
          }{
              \osInStack{\ovalue, \ovariable, \osMC{Retrieve'}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              [\omem], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        \end{mathpar}

        \begin{mathpar}
          \relationRule{Retrieve' from \obinding \,(goto parent)}{
              \osplat = \ovalue[\ovariable] \\
              \opscope' = \ovalue[\osFunc{Id}(\ostarvalue{parent})] \\
          }{
              \osInStack{\ovalue, \ovariable, \osMC{Retrieve'}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              [\opscope', \osMC{Get}, \ovariable, \osMC{Retrieve'}], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        \end{mathpar}

        \begin{mathpar}
          \relationRule{Retrieve' from \obinding \,(NameError)}{
              \obinding = \oheap[\opscope] \\
              \osplat = \obinding[\ovariable] \\
              \osplat = \obinding[\osFunc{Id}(\ostarvalue{parent})] \\
          }{
              \osInStack{\opscope, \ovariable, \osMC{Retrieve'}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
