      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{Get \omem}{
                  \ovariable = \oheap[\omem]
              }{
                  \olstack \listConcat [\omem, \osMC{Get}] \listConcat \omstack, \ostack, \oheap \osTransition
                  \olstack \listConcat [\ovariable] \listConcat \omstack, \ostack, \oheap
              }
      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{Call Assignment}{
                  ...
                  \omstack = [\ovariable_0, \osMC{LookUp}, \ostarvalue{value}, \osMC{Retrieve}, \osMC{Get}, \ldots, \ovariable_n, \osMC{LookUp}, \osMC{Convert} \;n]
              }{
                  [\;], [\osLR{\opscope, \olbl, \oprogram}] \listConcat \ostack, \oheap \osTransition
                  \omstack, [\osLR{\opscope, \olbl, \oprogram}] \listConcat \ostack, \oheap
              }
