...
\begin{document}
  ...
  \subsection{Micro-Instruction Rules}
        ...
        \begin{mathpar}
          \relationRule{ScopeRetrieve from \obinding \,(NameError)}{
              \obinding = \oheap[\opscope] \\
              \osplat = \obinding[\ovariable] \\
              \osplat = \obinding[\osFunc{Id}(\ostarvalue{parent})] \\
          }{
              \osInStack{\opscope, \ovariable, \osMC{ScopeRetrieve}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
      ...
      \begin{mathpar}
        ...
        \begin{mathpar}
          \relationRule{Attribute Assignment}{
              ...
              \omstack = [\opscope, \osMC{Alloc}, \ovariable_1, \osMC{LookUp}, \osMC{Get}, \ovariable_2, \osMC{LookUp}, \osMC{Get}, \ostarvalue{value}, \osMC{Retrieve}, \\ \osMC{Get}, \osMC{Retrieve}, \osMC{Dup}, \osMC{Get}, \osMC{Wrap}, \osMC{Store}, \ovariable, \osMC{Bind}, \osMC{Advance}]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
  ...
  \subsection{Helper Functions}
      ...
      \begin{definition}
        ...
        $\Delta = [\omem, \obinding_{\texttt{obj}}, \osMC{Store}, \omem', \ostarvalue{value}, \osMC{Bind}, \omem, \\
        \osMC{Alloc}, \osLR{\omem, \osMagic{Getattribute}}, \osMC{Store}, \osClown{getattribute}, \osMC{Bind}],
        \Gamma = [\omem, \osMC{Get}]$
        in
          \begin{equation}
