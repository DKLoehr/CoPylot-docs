        ...
        $ in
          ...
          \begin{multicols}{2}
            \begin{flalign*}
                ...
                & \osMC{Alloc}, \osLR{\omem, \osMagic{Call}}, \osMC{Store}, \\
                & \osClown{call}, \omem, \osMC{Bind}
                ]
            \end{flalign*}
            \begin{flalign*}
                & \osFunc{FillInt}(\omem) = \\
                ...
                & \osMC{Alloc}, \osLR{\omem, \osMagic{IntAdd}}, \osMC{Store}, \\
                & \osClown{add}, \omem, \osMC{Bind}, \\
                & \osMC{Alloc}, \osLR{\omem, \osMagic{IntNeg}}, \osMC{Store}, \\
                & \osClown{neg}, \omem, \osMC{Bind}
                ]
            \end{flalign*}
            \begin{flalign*}
                & \osFunc{Fillstr}(\omem) = \\
                ...
                & \osMC{Alloc}, \osLR{\omem, \osMagic{StrAdd}}, \osMC{Store}, \\
                & \osClown{add}, \omem, \osMC{Bind}, \\
                & \osMC{Alloc}, \osLR{\omem, \osMagic{StrContains}}, \osMC{Store}, \\
                & \osClown{contains}, \omem, \osMC{Bind}
                ]
            \end{flalign*}
