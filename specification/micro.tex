...
\begin{document}
        ...
        \begin{figure}\center
          ...
          \begin{definition} Initialization
            ...
            \osI{\osInit{\obinding}}{
                \{
                      \osType{AttributeError} \mapsto \omem_{\texttt{AttrError}},
                      \osType{FunctionType} \mapsto \omem_{\texttt{FunType}}
                \}
            } \\
            \osI{\osInit{\ostackframe}}{\osLR{\osInit{\olbl}, \osInit{\oprogram}}} \\
            \osI{\osInit{\ostack}}{[\osInit{\ostackframe}]} \\
            % \osI{\osInit{\oparent}}{\{\;\}} \\
            \osI{\osFunc{GetAttribute}}{\osLR{\opscope, \okw{def}(o,a) \ofuncarr
            \$1 = o.a; }} \\
            % \osI{\omagicf}{\{\;\}} \\
            % \osI{\omagicm}{\{\;\}} \\
          ...
          \end{flalign*}
          \text{\tnote{"if \$1 == None then return getattribute(o.\_\_class\_\_,a) else return \$1"}} \\
      ...
      \begin{figure}\center
          \begin{mathpar}
              ...
              \relationRule{Wrap \omem}{
                  ...
                  \olstack \listConcat [\omem, \osMC{Wrap}] \listConcat \omstack, \ostack, \oheap \osTransition
          ...
          \begin{figure}\center
              ...
              \relationRule{Gotoifn \olbl \,(success)}{
                  ...
                  \olstack \listConcat [\osMC{Goto}] \listConcat \omstack, \ostack, \oheap
              }
              ...
              \relationRule{Get Call \omem}{
                  \ovalue = \oheap[\omem_0][\ostarvalue{value}], \text{\;\ovalue\, is of form \ogenf\, or \ogenm} \\ % F,M
              ...
              \relationRule{Get Call (TypeError)}{
                  \ovalue = \oheap[\omem_0][\ostarvalue{value}], \text{\;\ovalue\, is not of form \ogenf\, or \ogenm} % *
              }{
                  \olstack \listConcat [\omem_0, \ldots, \omem_n, \osMC{GetCall} \;n] \listConcat \omstack, \ostack, \oheap \osTransition
                  [\osMC{AllocTypeError}, \osMC{Raise}], \ostack, \oheap
              }
      ...
      \begin{figure}
          ...
          \begin{definition}
            ...
            \oheap[\omem] = \ovalue,
            \obinding_{\texttt{obj}} = \{
                \ostarvalue{value} \mapsto \ovalue, \text{\_\_getattribute\_\_} \mapsto \osMagic{Getattribute} \} % the base object
            $$
              \begin{equation}
                \osGetObj (\oheap, \omem) =
                  \begin{cases}
