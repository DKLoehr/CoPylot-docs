...
\begin{document}
  ...
  \subsection{Micro-Instruction Rules}
        ...
        \begin{mathpar}
          \relationRule{Bind \omem \, to \ovariable \, in \opscope}{
              \omstack' = [\opscope, \osMC{Dup}, \osMC{Get}, \omem, \ovariable, \osMC{Update}, \osMC{Store}]
          }{
        ...
        \begin{mathpar}
          \relationRule{Update \obinding}{
              \obinding' = \obinding[\ovariable \mapsto \omem] \\
          }{
              \osInStack{\obinding, \omem, \ovariable, \osMC{Update}}, \ostack, \oheap \osTransition
              \osInStack{\obinding'}, \ostack, \oheap'
          }
        \end{mathpar}
        ...
        \begin{mathpar}
          \relationRule{Look up \ovariable}{
              \omstack' = [\opscope, \osMC{Get}, \ovariable, \osMC{ScopeRetrieve}]
          }{
              \osInStack{\ovariable, \osMC{LookUp}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \osInStack{\omstack'}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        \end{mathpar}
        ...
        \begin{mathpar}
          \relationRule{ScopeRetrieve from \obinding \,(locally bound)}{
              \omem = \ovalue[\ovariable] \\
          }{
              \osInStack{\ovalue, \ovariable, \osMC{ScopeRetrieve}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              [\omem], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        \end{mathpar}

        \begin{mathpar}
          \relationRule{ScopeRetrieve from \obinding \,(goto parent)}{
              \osplat = \ovalue[\ovariable] \\
              \opscope' = \ovalue[\osFunc{Id}(\ostarvalue{parent})] \\
          }{
              \osInStack{\ovalue, \ovariable, \osMC{ScopeRetrieve}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              [\opscope', \osMC{Get}, \ovariable, \osMC{ScopeRetrieve}], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        \end{mathpar}

        \begin{mathpar}
          \relationRule{ScopeRetrieve from \obinding \,(NameError)}{
              \osplat = \ovalue[\ovariable] \\
              \osplat = \ovalue[\osFunc{Id}(\ostarvalue{parent})] \\
          }{
              \osInStack{\ovalue, \ovariable, \osMC{ScopeRetrieve}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
        ...
        \begin{mathpar}
          \relationRule{Assign \ovalue \! to \ovariable}{
              \omstack' = [\opscope, \osMC{Alloc}, \osMC{Alloc}, \osMC{Dup}, \ovalue, \osMC{Store}, \ovalue, \osMC{Wrap}, \ovariable, \osMC{Bind}]
          }{
      ...
      \begin{mathpar}
        ...
        \begin{mathpar}
          \relationRule{Attribute Assignment}{
              ...
              \omstack = [\opscope, \osMC{Alloc}, \ovariable_1, \osMC{LookUp}, \osMC{Get}, \ovariable_2, \osMC{LookUp}, \osMC{Get}, \ostarvalue{value}, \osMC{Retrieve}, \\ \osMC{Get}, \osMC{Retrieve}, \osMC{Dup}, \osMC{Get}, \osMC{Wrap}, \ovariable, \osMC{Bind}, \osMC{Advance}]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        ...
        \begin{mathpar}
          \relationRule{Call Assignment}{
              ...
              \omstack = [\ovariable_0, \osMC{LookUp}, \osMC{Get}, \ostarvalue{value}, \osMC{Get}, \osMC{Retrieve}, \osMC{Get}, \ovariable_1, \osMC{LookUp}, \ldots, \ovariable_n, \osMC{LookUp}, \osMC{Alloc}, \osMC{Convert} \;n]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        ...
        \begin{mathpar}
          \relationRule{GotoIfNot}{
              ...
              \omstack = [\ovariable, \osMC{Lookup}, \osMC{Get}, \ostarvalue{value}, \osMC{Retrieve}, \osMC{Get}, \osMC{Gotoifn} \;\olbl'']
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
  ...
  \subsection{Helper Functions}
      ...
      \begin{definition}
        \begin{equation}
          \osFunc{Id}(\ovalue) = \text{string of } \ovalue
          \end{equation}
      \end{definition}
      ...
      \begin{definition}
        ...
        $\Delta = [\omem, \osMC{Dup}, \obinding_{\texttt{obj}}, \osMC{Store}, \omem', \ostarvalue{value}, \osMC{Bind}, \omem, \\
        \osMC{Dup}, \osMC{Alloc}, \osLR{\omem, \osMagic{Getattribute}}, \osMC{Store}, \osClown{getattribute}, \osMC{Bind}],
        \Gamma = [\omem]$
        in
          \begin{equation}
          ...
          \begin{multicols}{2}
            \begin{flalign*}
                ...
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{Call}}, \osMC{Store}, \\
            ...
            \begin{flalign*}
                ...
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{IntAdd}}, \osMC{Store}, \\
                & \osClown{add}, \osMC{Bind}, \\
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{IntNeg}}, \osMC{Store}, \\
            ...
            \begin{flalign*}
                ...
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{StrAdd}}, \osMC{Store}, \\
                & \osClown{add}, \osMC{Bind}, \\
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{StrContains}}, \osMC{Store}, \\
            ...
            \begin{flalign*}
                ...
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{LstIter}}, \osMC{Store}, \\
                & \osClown{iter}, \osMC{Bind}, \\
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{LstContains}}, \osMC{Store}, \\
                & \osClown{contains}, \osMC{Bind}
                ]
            \end{flalign*}
            \begin{flalign*}
                ...
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{TplIter}}, \osMC{Store}, \\
                & \osClown{iter}, \osMC{Bind}, \\
                & \omem, \osMC{Alloc}, \osMC{Dup}, \osLR{\omem, \osMagic{TplContains}}, \osMC{Store}, \\
                & \osClown{contains}, \osMC{Bind}
                ]
            \end{flalign*}
    ...
    \section{Graph Semantics}
      ...
      \begin{mathpar}
        \relationRule{Update \obinding}{
            \gnode_1 \gsBefore \gnode_2 \in \ggraph \\
            \gnode_2 = \gsLR{\olbl, \osInStack{\obinding, \omem, \ovariable, \osMC{Update}}, \gtime} \\
            \obinding' = \obinding[\ovariable \mapsto \omem] \\
        }{
            \gsAddEdge{\gnode_2 \gsBefore \gsLR{\olbl, \osInStack{\obinding'}, \gtime + 1}}
        }
      \end{mathpar}
      ...
      \begin{mathpar}
        \relationRule{ScopeRetrieve from \obinding \,(locally bound)}{
            \gnode_1 \gsBefore \gnode_2 \in \ggraph \\
            \gnode_2 = \gsLR{\olbl, \osInStack{\ovalue, \ovariable, \osMC{ScopeRetrieve}}, \gtime} \\
      ...
      \begin{mathpar}
        \relationRule{ScopeRetrieve from \obinding \,(NameError)}{
            ...
            \osplat = \ovalue[\ovariable] \\
            \osplat = \ovalue[\osFunc{Id}(\ostarvalue{parent})] \\
            \omstack' = [\osMC{AllocNameError}, \osMC{Raise}]
        }{
            \gsAddEdge{\gnode_2 \gsBefore \gsLR{\olbl, \osInStack{\omstack'}, \gtime + 1}}
        }
      \end{mathpar}
      ...
      \ExecuteMetaData [magic]{graph-unop}
      ...
      \begin{definition}[Get Value]
          ...
          \begin{itemize}
            \item If $\gnode_1 \gsBefore \gnode_0 \in \ggraph,
                      \gnode_1 = \gsLR{\olbl, \osInStack{\omem, \ovalue, \osMC{Store}}, \gtime},
