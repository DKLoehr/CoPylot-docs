  ...
  \subsection{Micro-Instruction Rules}
        ...
        \begin{mathpar}
          \relationRule{Bind \omem \, to \ovariable \, in \opscope}{
              ...
              \osInStack{\omem, \ovariable, \opscope, \osMC{Bind}}, \ostack, \oheap \osTransition
        ...
        \begin{mathpar}
          \relationRule{Advance (end of function)}{
              ...
              \omstack' = [\osMC{Pop}, \omem_{\osnone}, \ovariable, \opscope', \osMC{Bind},  \osMC{Advance}]
          }{
        ...
        \begin{mathpar}
          \relationRule{Raise \,(caught)}{
              ...
              \omstack' = [\ovariable, \opscope, \osMC{Bind}, \osMC{Advance}]
          }{
              \osInStack{\osMC{Raise}}, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
        ...
        \begin{mathpar}
          \relationRule{Call function \omem}{
            ...
            \omstack' = [\opscope, \osMC{Push} \;\olbl, \omem_1, \ovariable_1, \opscope, \osMC{Bind}, \ldots, \omem_n, \ovariable_n, \opscope, \osMC{Bind}]
          }{
        ...
        \begin{mathpar}
          \relationRule{Assign \ovalue \! to \ovariable}{
              \omstack' = [\osMC{Alloc}, \osMC{Alloc}, \ovalue, \osMC{Store}, \ovalue, \osMC{Wrap}, \osMC{Store}, \ovariable, \opscope, \osMC{Bind}]
          }{
      ...
      \begin{mathpar}
        ...
        \begin{mathpar}
          \relationRule{Name Assignment}{
              ...
              \omstack = [\ovariable_2, \osMC{Lookup}, \ovariable_1, \opscope, \osMC{Bind}, \osMC{Advance}]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        ...
        \begin{mathpar}
          \relationRule{Attribute Assignment}{
              ...
              \omstack = [\osMC{Alloc}, \ovariable_1, \osMC{LookUp}, \osMC{Get}, \ovariable_2, \osMC{Retrieve}, \osMC{Dup}, \osMC{Get}, \osMC{Wrap}, \osMC{Store}, \ovariable, \opscope, \osMC{Bind}, \osMC{Advance}]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        ...
        \begin{mathpar}
          \relationRule{Return}{
              ...
              \oprogram(\olbl'') = \olbl'':\oglbl''': \ovariable' \gteq \oexpr \\
              \omstack = [\ovariable, \osMC{LookUp}, \osMC{Pop}, \ovariable', \opscope', \osMC{Bind},\osMC{Advance}]
          }{
              [\;], [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap \osTransition
              \omstack, [\osLR{\opscope, \olbl}] \listConcat \ostack, \oheap
          }
        ...
        $ in
          \begin{equation}
            ...
            \begin{cases}
              ...
              [\omem] \listConcat \osFunc{FillMet}(\omem, \obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \ogenm \\
              [\omem] \listConcat \osFunc{FillInt}(\omem, \obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \mathbb{Z} \\
              [\omem] \listConcat \osFunc{FillStr}(\omem, \obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \mathbb{S} \\
              [\omem] \listConcat \osFunc{FillLst}(\omem, \obinding_{\texttt{obj}}), & \text{if}\; \ovalue = [\omem_1, \omem_2, \ldots] \\
              [\omem] \listConcat \osFunc{FillTpl}(\omem, \obinding_{\texttt{obj}}), & \text{if}\; \ovalue = (\omem_1, \omem_2, \ldots) \\
            \end{cases}
          \end{equation}
          \begin{multicols}{2}
            \begin{flalign*}
                & \osFunc{FillMet}(\omem, \obinding_{\texttt{obj}}) = \\
                & [
                \osMem{MetType}, \osClown{class}, \omem, \osMC{Bind}, \\
                & \osLR{\omem, \osMagic{Call}}, \osClown{call}, \omem, \osMC{Bind}, \\
                & \obinding_{\texttt{obj}}
                ]
            \end{flalign*}
            \begin{flalign*}
                & \osFunc{FillInt}(\omem, \obinding_{\texttt{obj}}) = \\
                & [
                \osMem{IntType}, \osClown{class}, \omem, \osMC{Bind}, \\
                & \osLR{\omem, \osMagic{IntAdd}}, \osClown{add}, \omem, \osMC{Bind}, \\
                & \osLR{\omem, \osMagic{IntNeg}}, \osClown{neg}, \omem, \osMC{Bind}, \\
                & \obinding_{\texttt{obj}}
                ]
            \end{flalign*}
            \begin{flalign*}
                & \osFunc{Fillstr}(\omem, \obinding_{\texttt{obj}}) = \\
                & [
                \osMem{StrType}, \osClown{class}, \omem, \osMC{Bind}, \\
                & \osLR{\omem, \osMagic{StrAdd}}, \osClown{add}, \omem, \osMC{Bind}, \\
                & \osLR{\omem, \osMagic{StrContains}}, \osClown{contains}, \omem, \osMC{Bind}, \\
                & \obinding_{\texttt{obj}}
                ]
            \end{flalign*}
            ...
            %     & \osClown{add} \mapsto \osLR{\omem, \osMagic{StrAdd}}, \\
            %     & \osClown{contains} \mapsto \osLR{\omem, \osMagic{StrContains}}] \\
            % \end{flalign*}
            % \begin{flalign*}
            %     \osFunc{FillLst}
            %     & (\omem, \obinding_{\texttt{obj}}) = \obinding_{\texttt{obj}} \\
            %     & [\osClown{class} \mapsto \osMem{LstType}, \\
            %     & \osClown{iter} \mapsto \osLR{\omem, \osMagic{LstIter}}, \\
            %     & \osClown{contains} \mapsto \osLR{\omem, \osMagic{LstContains}}, \\
            %     & \osClown{getitem} \mapsto \osLR{\omem, \osMagic{LstGetitem}}] \\
            % \end{flalign*}
            % \begin{flalign*}
            %     \osFunc{FillTpl}
            %     & (\omem, \obinding_{\texttt{obj}}) = \obinding_{\texttt{obj}} \\
