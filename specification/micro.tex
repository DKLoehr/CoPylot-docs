        ...
        $ in
          \begin{equation}
            ...
            \begin{cases}
              ...
              \osFunc{GetMetObj}(\obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \ogenm \\
              \osFunc{GetIntObj}(\obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \mathbb{Z} \\
              \osFunc{GetStrObj}(\obinding_{\texttt{obj}}), & \text{if}\; \ovalue = \mathbb{S} \\
              \osFunc{GetLstObj}(\obinding_{\texttt{obj}}), & \text{if}\; \ovalue = [\omem, \ldots] \\
              \osFunc{GetTupObj}(\obinding_{\texttt{obj}}), & \text{if}\; \ovalue = (\omem, \ldots) \\
            \end{cases}
          \end{equation}
          \begin{multicols}{2}
            \begin{flalign*}
                \osFunc{GetMetObj} (\obinding_{\texttt{obj}})
                & = \obinding_{\texttt{obj}} \\
                & [\osClown{class} \mapsto \osMem{MetType}] \\
            \end{flalign*}
            \begin{flalign*}
                \osFunc{GetIntObj} (\obinding_{\texttt{obj}})
                & = \obinding_{\texttt{obj}} \\
                & [\osClown{add} \mapsto \osMagic{IntAdd}, \\
                & \osClown{neg} \mapsto \osMagic{IntNeg}] \\
            \end{flalign*}
            \begin{flalign*}
                \osFunc{GetStrObj} (\obinding_{\texttt{obj}})
                & = \obinding_{\texttt{obj}} \\
                & [\osClown{add} \mapsto \osMagic{StrAdd}, \\
                & \osClown{neg} \mapsto \osMagic{StrContains}] \\
            \end{flalign*}
            \begin{flalign*}
                \osFunc{GetLstObj} (\obinding_{\texttt{obj}})
                & = \obinding_{\texttt{obj}} \\
            ...
            \end{flalign*}
            \begin{flalign*}
                \osFunc{GetTupObj} (\obinding_{\texttt{obj}})
                & = \obinding_{\texttt{obj}} \\
