...
\begin{mathpar}
  \relationRule{Assert Method (base case)}{
    \omstack' =
    \begin{cases}
      [\;], & \text{if}\; \ovalue \in \ogenm \cr
      [\osMC{AllocTypeError}, \osMC{Raise}], & \text{otherwise}
    \end{cases} \\
  }{
    \osInStack{\ovalue, \osMem{MetType}, \osMC{Assert} \;1}, \ostack, \oheap \osTransition
    \osInStack{\omstack'}, \ostack, \oheap
  }
\end{mathpar}

\begin{mathpar}
  \relationRule{Assert Int (base case)}{
    \omstack' =
    \begin{cases}
      [\;], & \text{if}\; \ovalue \in \mathbb{Z} \cr
      [\osMC{AllocTypeError}, \osMC{Raise}], & \text{otherwise}
    ...
    \osInStack{\ovalue, \osMem{IntType}, \osMC{Assert} \;1}, \ostack, \oheap \osTransition
    \osInStack{\omstack'}, \ostack, \oheap
  }
\end{mathpar}

\begin{mathpar}
  \relationRule{Assert String (base case)}{
    \omstack' =
    \begin{cases}
      [\;], & \text{if}\; \ovalue \in \mathbb{S} \cr
      [\osMC{AllocTypeError}, \osMC{Raise}], & \text{otherwise}
    ...
    \osInStack{\ovalue, \osMem{StrType}, \osMC{Assert} \;1}, \ostack, \oheap \osTransition
    \osInStack{\omstack'}, \ostack, \oheap
  }
\end{mathpar}

\begin{mathpar}
  \relationRule{Assert List (base case)}{
    \omstack' =
    \begin{cases}
      [\;], & \text{if}\; \ovalue \text{ is of form } [\omem, \ldots] \cr
      [\osMC{AllocTypeError}, \osMC{Raise}], & \text{otherwise}
    ...
    \osInStack{\ovalue, \osMem{LstType}, \osMC{Assert} \;1}, \ostack, \oheap \osTransition
    \osInStack{\omstack'}, \ostack, \oheap
  }
\end{mathpar}

\begin{mathpar}
  \relationRule{Assert Tuple (base case)}{
    \omstack' =
    \begin{cases}
      [\;], & \text{if}\; \ovalue \text{ is of form } (\omem, \ldots) \cr
      [\osMC{AllocTypeError}, \osMC{Raise}], & \text{otherwise}
    ...
    \osInStack{\ovalue, \osMem{TplType}, \osMC{Assert} \;1}, \ostack, \oheap \osTransition
    \osInStack{\omstack'}, \ostack, \oheap
  }
\end{mathpar}
