...
\newcommand{\okw}[1]{\;\text{\texttt{{\color{purple}#1}}}\;}

\newcommand{\osend}{\text{\textsmaller{\sc End}}}
\newcommand{\ostrue}{\text{\textsmaller{\sc True}}}
\newcommand{\osfalse}{\text{\textsmaller{\sc False}}}
\newcommand{\osBefore}[1]{\mathrel{\stackrel{{\scriptscriptstyle\boldsymbol{#1}}}{\lexicallyBefore}}}
\newcommand{\osLookup}{\text{\textsmaller{\sc Lookup}}}
\newcommand{\osBind}{\text{\textsmaller{\sc Bind}}}
