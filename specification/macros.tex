...
\newcommand{\gsadvance}[1][]{\text{\textsmaller{{\color{node}\sc Advance }}} #1}
\newcommand{\gsreturn}[1][]{\text{\textsmaller{{\color{node}\sc Return }}} #1}
\newcommand{\gsraise}[1][]{\text{\textsmaller{{\color{node}\sc Raise }}} #1}
\newcommand{\gsifresult}[1][]{\text{\textsmaller{{\color{node}\sc Ifresult }}} #1}
% Relations
