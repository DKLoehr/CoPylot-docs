...
\newcommand{\gsadvance}[1][]{\text{\textsmaller{{\color{node}\sc Advance }}}\ostmt #1}
\newcommand{\gsreturn}[1][]{\text{\textsmaller{{\color{node}\sc Return }}}\ostmt #1}
\newcommand{\gsraise}[1][]{\text{\textsmaller{{\color{node}\sc Raise }}}\ostmt #1}
\newcommand{\gsifresult}[1][]{\text{\textsmaller{{\color{node}\sc Ifresult }}}\ostmt #1}
% Relations
