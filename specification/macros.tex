...
% \definecolor{microcode}{HTML}{D26937} % orange
% \definecolor{microcode}{HTML}{2AA889} % green
% \definecolor{microcode}{HTML}{4E5166} % violet
% \definecolor{microcode}{HTML}{888CA6} % magenta
...
\newcommand{\tnote}[1]{\textit{\color{flame}(#1 -- TC)}}
...
\newcommand{\osType}[1]{\text{\textsmaller{{\color{func}\sc #1}}}}
