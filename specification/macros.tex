...
\newcommand{\gsadvance}[1][]{\text{\textsmaller{{\color{func}\sc Advance }}}\ostmt #1}
\newcommand{\gsreturn}[1][]{\text{\textsmaller{{\color{func}\sc Return }}}\ostmt #1}
\newcommand{\gsraise}[1][]{\text{\textsmaller{{\color{func}\sc Raise }}}\ostmt #1}
% Relations
...
\newcommand{\gsBeforeIn}[1][]{%
  \ifthenelse{\equal{#1}{}}{%
    \overset{?}{\underset{\ggraph}{\gsBefore}}%
  }{%
