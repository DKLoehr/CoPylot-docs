...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Advance End of Try}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsadvance[\ostmt_0][_0], \gtime \tplus}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Advance End of Exception}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsadvance[\gsraise[\ostmt'][']][_0], \gtime \tplus}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Ifresult Through Blocks}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsifresult[\ostmt_0][_0], \gtime \tplus}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\ostmt_2, \gtime \tplus}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise Pop}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsraise[\ostmt_0][_0], \gtime \tplus}}
    }
  \end{mathpar}
