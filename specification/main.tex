...
\begin{document}
    ...
    \subsection{Grammar}
        ...
        \begin{figure}\center
              ...
              \begin{definition}
                  \begin{equation}
                      \osCatch (\osLR{\oparent,\olbl,\oprogram,\omem}) \gteq
                      \begin{cases}
                        \olbl', \ovariable, \omem' & \text{if}\ \odirective' \gteq \okw{catch} \ovariable \\
              ...
              \begin{definition}
                $\oheap[\omem][\text{\_\_call\_\_}] \gteq \omem'
                , \oheap[\omem'] \gteq \ovalue$
                  \begin{equation}
                    \osGetCall (\oheap, \omem) \gteq
                      \begin{cases}
                        \osGetCall (\oheap, \omem'), & \text{if }\ \ovalue \gteq \obinding \\
                        \omem',
                        & \text{if } \ovalue \gteq \osLR{\omem_0,\okw{def}(\ovariable_1,\ldots,\ovariable_n) \ofuncarr \oprogram} \;|\;
            ...
            \begin{figure}\center
              ...
              \relationRule{Function Assignment}{
                  ...
                  \obinding_{\texttt{obj}} \gteq \{\ostarvalue{value} \mapsto \omem, \text{\_\_call\_\_} \mapsto \omem \} \\
                  \oheap' \gteq \oheap[\omem \mapsto \ovalue, \omem' \mapsto \obinding_{\texttt{obj}}] \\
                  \omem,\omem' \notin \oheap \\
                  % \obinding \gteq \oenv(\omem_0) \\
                  % \obinding' \gteq \obinding[\ovariable_1 \mapsto \omem] \\
              ...
              \relationRule{Function Call Assignment}{
                  ...
                  \omem_{\texttt{raw}} \gteq \osLookup (\omem_0,\oparent,\oheap,\ovariable_2)\\
                  \omem \gteq \osGetCall(\oheap,\omem_{\texttt{raw}}) \\
                  \oheap[\omem][\ostarvalue{obj}] \gteq \osLR{ \omem_0',\okw{def}(\ovariable_3',\ldots,\ovariable_n') \ofuncarr \oprogram' } \\
                  \omem_0'' \notin \oheap \\
          ...
          \ContinuedFloat
            \begin{mathpar}
              ...
              \relationRule{Method Call Assignment}{
                  ...
                  \omem_{\texttt{raw}} \gteq \osLookup (\omem_0,\oparent,\oheap,\ovariable_2)\\
                  \omem \gteq \osGetCall(\oheap,\omem_{\texttt{raw}}) \\
                  \oheap[\omem][\ostarvalue{obj}] \gteq \osLR{ \omem_0',\omem_{\texttt{obj}}, \okw{def}(\ovariable_3',\ldots,\ovariable_n') \ofuncarr \oprogram' } \\
                  \omem_0'' \notin \oheap \\
                  \oheap' \gteq \oheap[\omem_0'' \mapsto \{\ovariable_{\texttt{self}} \mapsto \omem_\texttt{obj}\}] \\
                  \forall i, 3 \leq i \leq n, \omem_i' \gteq \osLookup (\omem_0,\oparent,\oheap,\ovariable_i) \\
                  \osBind  (\oheap', \omem_0'', \ovariable_1', \omem_1', \ldots, \ovariable_n', \omem_n') \gteq \oheap'' \\
                  \oparent' \gteq \oparent \cup \{\omem_0'' \mapsto \omem_0'\} \\
                  \oprogram' \gteq [\olbl'':\olbl''':\odirective, \ldots]
              ...
              \relationRule{Attribute Assignment}{
                  ...
                  \obinding_{\texttt{obj}} \gteq \osGetObj (\oheap, \omem') \\
                  \omem'' \notin \oheap \\
              ...
              \relationRule{Raise Exception Caught}{
                  ...
                  % \olbl_1 \gteq \olbl' \\
                  \omem_0^0 \gteq \omem_0 \\
                  \forall i, 1 \leq i \leq k, k < n, \osCatch (\osLR{\oparent,\olbl_i,\oprogram_i,\omem_0^{i-1}}) \gteq \okw{undefined}, \okw{undefined}, \omem_0^i \\
                  \osCatch(\osLR{\oparent,\olbl_{k+1},\oprogram_{k+1},\omem_0^k}) \gteq \olbl', \ovariable', \omem_0' \\
...
%
                  ...
                  % \obinding' \gteq \obinding[\ovariable_1 \mapsto \omem] \\
                  % \oenv' \gteq \oenv[\omem_0' \mapsto \obinding'] \\
                  \oprogram'(\olbl'') = \olbl'':\olbl''':\ovariable_1 \gteq \oexpr \\
                  \osBind (\oheap,\omem_0',\ovariable_1,\omem) \gteq \oheap' \\
%
                  \olbl'' \osBefore{S'} \oglbl'''' \\
              }{
