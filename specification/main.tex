...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{If Return (\ovalvariable)}{
      \\
    }{
      [\gtlet \ovalvariable \gteq \gtobrc [\gtifreturn \ovalvariable' \gtsemi] \listConcat \osBlock{if} \gtcbrc \gtsemi] \listConcat \otstmts', \oheap \osTransition
  ...
  \begin{mathpar}
    \relationRule{If Return (\omemvariable)}{
      \\
    }{
      [\gtlet \omemvariable \gteq \gtobrc [\gtreturn \ovalvariable' \gtsemi] \listConcat \osBlock{if} \gtcbrc \gtsemi] \listConcat \otstmts', \oheap \osTransition
  ...
  \begin{mathpar}
    \relationRule{Haskey}{
      ...
      \ovalue =
      \begin{cases}
        \ostrue, & \text{if } \ovalue_1[\ovalue_2] = \omem \cr
