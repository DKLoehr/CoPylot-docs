  ...
  \begin{definition}[Lookup]
    ...
    \begin{enumerate}%[label=(\alph*)]
      ...
      \begin{enumerate}[label=(\alph*)]
        ...
        then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1, [\omemvariable_n, \lInstr{Capture}_{2n}, \lInstr{Jump}\;\gnode_1, \ldots, \omemvariable_1, \lInstr{Capture}_{2}, \lInstr{Jump}\;\gnode_1,  \lInstr{List}_n] \listConcat \lstack')$.
