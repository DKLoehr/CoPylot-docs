...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{If Return (\omemvariable)}{
      ...
      [\gtlet \omemvariable \gteq \gtobrc [\gtreturn \ovalvariable' \gtsemi] \listConcat \osBlock{if} \gtcbrc] \listConcat \otstmts', \oheap \osTransition
  ...
  \begin{mathpar}
    \relationRule{Raise in If (\ovalvariable)}{
      ...
      [\gtlet \ovalvariable \gteq \osBlock{if} \gtsemi] \listConcat \otstmts', \oheap \osTransition
      [\gtraise \omemvariable \gtsemi] \listConcat \otstmts', \oheap
    }
  \end{mathpar}
