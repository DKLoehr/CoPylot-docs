...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Return}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsadvance[\ostmt_0], \gtime + 1}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise Pop}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsraise[\ostmt_0], \gtime + 1}}
    }
  \end{mathpar}
  ...
  \begin{definition}[Lookup]
    ...
    \begin{enumerate}[label=(\alph*)]
      ...
      If $\gnode_1 = \gsLR{\olbl \gtcolon \gtifresult \ovalvariable, \gtime}$, \\
         ...
         $\lstack = [\ovalvariable_3] \listConcat \lstack'$, and
         $\ovalvariable_3 \neq \ovalvariable_1$
      then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1, [\gsLR{\olbl \gtcolon \gtlet \ovalvariable' \gteq \gtif \ovalvariable'' \gtthen \gtobrc \ostmts_1 \gtcbrc \gtelse \gtobrc \ostmts_2 \gtcbrc, \gtime'}] \listConcat \lstack')$.
