...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{If True}{
      ...
      [\gtlet \ovalvariable \gteq \gtif \ovalvariable' \gtthen \gtobrc \otstmts_1 \gtcbrc \gtelse \gtobrc \otstmts_2 \gtcbrc] \listConcat \otstmts, \oheap \osTransition
      [\gtlet \ovalvariable \gteq \gtobrc \osBlock[_2]{if} \gtcbrc] \listConcat \otstmts, \oheap
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{If Return}{
      ...
      [\gtlet \ovalvariable \gteq \ovalvariable'] \listConcat \otstmts', \oheap
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Try Block}{
      ...
      [\gttry \gtobrc \otstmts_1 \gtcbrc \gtexcept \omemvariable \gtobrc \otstmts_2 \gtcbrc] \listConcat \otstmts, \oheap \osTransition
      [\gttry \gtobrc \otstmts_1' \gtcbrc \gtexcept \omemvariable \gtobrc \otstmts_2 \gtcbrc] \listConcat \otstmts, \oheap'
    }
  \end{mathpar}
