...
\begin{document}
  ...
  \begin{definition}[Lookup]
    ...
    \begin{enumerate}%[label=(\alph*)]
      ...
      \tnote{fix ifreults in a moment}

      \item \rulename{Ifresult \ovalvariable \;(bound)}
      If $\gnode_1 = \gsLR{\gsifresult [\olbl \gtcolon \gtifresult \ovalvariable], \gtime_1}$, \\
      ...
      If $\gnode_1 = \gsLR{\gsifresult [\olbl \gtcolon \gtifresult \omemvariable], \gtime_1}$, \\
