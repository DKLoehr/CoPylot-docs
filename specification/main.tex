        ...
        \begin{figure}\center
            ...
            \begin{figure}\center
              ...
              \relationRule{Name Assignment}{
                  \oprogram(\olbl) = \olbl:\olbl':\ovariable_1 = \ovalue_2 \\
          ...
          \ContinuedFloat
            \begin{mathpar}
              ...
              \relationRule{Raise Exception Caught}{
                  ...
                  % \olbl_1 = \olbl' \\
                  \omem_0^0 = \omem_0 \\
                  \forall i, 1 \leq i \leq k, k < n, \osCatch (\osLR{\oparent,\olbl_i,\oprogram_i,\omem_0^{i-1}}) = \okw{undefined}, \okw{undefined}, \omem_0^i \\
                  \osCatch(\osLR{\oparent,\olbl_{k+1},\oprogram_{k+1},\omem_0^k}) = \olbl', \ovariable', \omem_0' \\
              ...
              \relationRule{Raise Exception Escaped}{
                  ...
                  \ostack = [\osLR{\olbl_1,\oprogram_1},\ldots,\osLR{\olbl_n,\oprogram_n}] \\
                  \olbl_1 = \olbl' \\
                  \forall i, 1 \leq i \leq n, \osCatch (\osLR{\olbl_i,\oprogram_i}) = \okw{undefined} \\
              }{
                  [\osLR{ \olbl,\oprogram }] \listConcat \ostack,\oheap,\oparent,\omem_0 \osTransition
