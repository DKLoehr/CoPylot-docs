...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Equal \ovalvariable}{
      \ovalue_1 = \oheap[\ovalvariable_1] \\
      \ovalue_2 = \oheap[\ovalvariable_2] \\
      \ovalue =
      \begin{cases}
  ...
  \begin{mathpar}
    \relationRule{Equal \omemvariable}{
      ...
      [\gtlet \ovalvariable \gteq \omemvariable_1 \gtcmp \omemvariable_2 \gtsemi] \listConcat \otstmts, \oheap \osTransition
      \otstmts, \oheap'
    }
  \end{mathpar}
  ...
  \begin{definition}[Skippable statements]
    ...
    \begin{flalign*}
      ...
      & \gtlet \ovalvariable \gteq \ovalvariable \gtobrk \ovalvariable \gtcolon \ovalvariable \gtcbrk, \gtstore \omemvariable \; \ovalvariable, \gtlet \ovalvariable \gteq \gtget \omemvariable, \gtlet \ovalvariable \gteq \ounop \ovalvariable, \gtlet \ovalvariable \gteq \ovalvariable \obinop \ovalvariable}
    \end{flalign*}
  \end{definition}
  ...
  \begin{mathpar}
    \relationRule{Advance End of Exception}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsadvance[\gsraise[\ostmt'][']][_0], \gtime \tpop}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Ifresult Through Blocks}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsifresult[\ostmt_0][_0], \gtime \tpop}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise}{
      ...
      \ostmt' = \olbl \gtcolon \gttry \gtobrc \ostmts_1 \gtcbrc \gtexcept \omemvariable \gtobrc \ostmts_2 \gtcbrc \\
      \ostmts_2 = [\ostmt_2, \ldots]
      \gnode_3 = \gsLR{\gsadvance[\ostmt']['\tpop], \gtime \tplus}
    }{
      \gsAddEdge{\gnode_2 \gsBefore \gnode_3, \gnode_3 \gsBefore \gsLR{\ostmt_2, \gtime \tplus \tpop \tpush}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise Pop}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsraise[\ostmt_0][_0], \gtime \tpop}}
    }
  \end{mathpar}
  ...
  \begin{definition}[Lookup]
    ...
    \begin{enumerate}%[label=(\alph*)]
      ...
      If $\gnode_1 = \gsLR{\olbl \gtcolon \gtstore \omemvariable \; \ovalvariable}$, and
         $\lstack = [\omemvariable] \listConcat \lstack'$,
      then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1,  \listConcat \lstack')$.
      ...
      \item \rulename{List Concatenation}
      ...
      \item \rulename{Equal \ovalvariable}
      ...
      \item \rulename{Equal \omemvariable}
      ...
      \item \rulename{Function Return \;(bound)}
      ...
      \item \rulename{Function Return \;(unbound)}
      If $\gnode_1 = \gsLR{\gsreturn [\ostmt], \gtime_1}$,
      ...
      \item \rulename{Cmp Rule \ovalue}
      If $\lstack = [\lInstr{Cmp}, \ovalue_1, \ovalue_2] \listConcat \lstack'$, and
         \begin{flalign*}
           \ovalue =
           \begin{cases}
             \ostrue, & \text{if } \ovalue_1 = \ovalue_2 \\
             \osfalse, & \text{if } \ovalue_1 \neq \ovalue_2,
           \end{cases}
         \end{flalign*}
      then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1, [\ovalue] \listConcat \lstack')$.

      \item \rulename{Cmp Rule \omem}
      If $\lstack = [\lInstr{Cmp}, \omem_1, \omem_2] \listConcat \lstack'$, and
         \begin{flalign*}
           \ovalue =
           \begin{cases}
