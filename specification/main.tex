...
\begin{document}
    ...
    \subsection{Grammar}
        ...
        \begin{figure}\center
              ...
              \begin{definition}
                $$
                  \text{\textsmaller{\sc Bind}}(\oheap,\omem_0,\ovariable,\omem) \gteq \oheap' \text{ such that } \obinding \gteq \oheap. \obinding' \gteq \obinding[\ovariable \mapsto \omem], \oheap' \gteq \oheap[\omem_0 \mapsto \obinding']
                $$

              \end{definition}
              \begin{definition}
                $$
                  \text{\textsmaller{\sc Bind}}(\oheap,\omem_0,\ovariable_1,\omem_1,\ldots,\ovariable_n,\omem_n) \gteq \oheap' \text{ such that } \obinding \gteq \oheap. \obinding' \gteq \obinding[\ovariable \mapsto \omem], \oheap' \gteq \oheap[\omem_0 \mapsto \obinding']
                $$
              ...
              \relationRule{Literal Assignment}{
                  ...
                  \obinding_{\texttt{obj}} \gteq \{\star \ovariable_{\texttt{value}} \mapsto \omem\} \\
              ...
              \relationRule{Function Assignment}{
                  ...
                  \ovalue \gteq \osLR{ \eta, \okw{def}(\ovariable_2, \ldots, \ovariable_n) \ofuncarr \oprogram } \\
                  \obinding_{\texttt{obj}} \gteq \{\star \ovariable_{\texttt{value}} \mapsto \omem\} \\
                  \oheap' \gteq \oheap[\omem \mapsto \ovalue, \omem' \mapsto \obinding_{\texttt{obj}}] \\
                  \omem,\omem' \notin \oheap \\
                  % \obinding \gteq \oenv(\omem_0) \\
            ...
            \begin{figure}\center
              ...
              \relationRule{Function Call Assignment}{
                  ...
                  \omem \gteq \osLookup (\omem_0,\oparent,\oheap,\ovariable_2)\\
                  \oheap[\omem] \gteq \osLR{ \omem_0',\okw{def}(\ovariable_3',\ldots,\ovariable_n') \mapsto \oprogram' } \\
                  \omem_0'' \notin \oheap \\
                  \oheap' \gteq \oheap[\omem_0'' \mapsto \{\;\}] \\
                  \forall i, 3 \leq i \leq n, \omem' \gteq \osLookup (\omem_0,\oparent,\oheap,\ovariable_i) \\
                  % \obinding' \gteq \obinding [\ovariable_4 \mapsto \omem'] \\
                  % \oenv' \gteq \oenv[\omem_0'' \mapsto \obinding'] \\
                  \osBind (\oheap',\omem_0'',\ovariable_i,\omem_i,\ldots,\ovariable_n,\omem_n) \gteq \oheap'' \\
              ...
              \relationRule{Method Assignment}{
                  ...
                  \omem \gteq \osLookup(\omem_0,\oparent,\oheap,\ovariable_2) \\
                  \omem[\ovariable_3] \gteq \omem' \\
                  \oheap[\omem'] = \osLR{\omem_0, \omem, \okw{def} \ovariable_4 (\ovariable_5,\ldots) \ofuncarr \oprogram'} \\
                  \obinding_{\texttt{obj}} \gteq \{\star \ovariable_{\texttt{value}} \mapsto \omem'\} \\
              ...
              \relationRule{Magic Method Assignment}{
                  \oprogram(\olbl) \gteq \olbl:olbl':\ovariable_1 \gteq \ovariable_2.\ovariable_3 \\
                  \omem \gteq \osLookup(\omem_0,\oparent,\oheap,\ovariable_2) \\
                  \omem[\ovariable_3] \gteq \omem' \\
                  \oheap[\omem'] = \osLR{ \omem'', \omagicm } \\
                  \obinding_{\texttt{obj}} \gteq \{\star \ovariable_{\texttt{value}} \mapsto \omem'\} \\
                  \oheap' \gteq \oheap[\omem'' \mapsto \obinding_{\texttt{obj}}] \\
                  \omem', \omem', \omem \notin \oheap \\
                  \osBind (\oheap',\omem_0,\ovariable_1,\omem'') \gteq \oheap'' \\
