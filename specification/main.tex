...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Slice (imprecise)}{ % TODO: how to address error
  ...
  \tnote{TODO: fill in these charts}
  ...
  \begin{definition}[Imprecise Slice]
    ...
    \begin{array}[t]{ c | c c c c }
     & \gtintplus & \gtintminus & \gtintzero & \osnone \\
     \hline
     \gtintplus & \osBag{\omem_i,\ldots,\omem_j}, \omem_i,\ldots,\omem_j \in \ovalue & \text{---} & \text{---} & \osBag{\omem_i,\ldots,\omem_j}, \omem_i,\ldots,\omem_j \in \ovalue \\
     \gtintminus & \text{---} & \text{---} & \text{---} & \text{---} \\
     \gtintzero & \osBag{\omem_i,\ldots,\omem_j}, \omem_i,\ldots,\omem_j \in \ovalue & \text{---} & \ovalue & \ovalue \\
     \osnone & \osBag{\omem_i,\ldots,\omem_j}, \omem_i,\ldots,\omem_j \in \ovalue & \text{---} & \ovalue & \ovalue \\
    \end{array}
    \end{flalign*}
  \end{definition}
\end{document}
