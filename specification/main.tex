...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Advance End of Exception}{
      \gnode_1 \gsBeforeIn \gnode_2 \\
      \gnode_2 = \gsLR{\gsadvance[\ostmt][_s], \gtime}\\
      \ostmt \osBefore \osplat \\
      \ostmt_1 \osStartof \ostmt \\
      \gsLR{\gsraise[\ostmt']['], \gtime_0} \gsBeforeIn \gsLR{\ostmt_1,\gtime_1} \\
    }{
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsadvance[\gsraise[\ostmt'][']][_0], \gtime + 1}}
    }
  \end{mathpar}
