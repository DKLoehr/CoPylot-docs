...
\begin{document}
  ...
  \begin{mathpar}
    \relationRule{Try}{
      \gnode_1 \gsBeforeIn \gnode_2 \\
      \gnode_2 = \gsLR{\ostmt, \gtime}\\\\
      \ostmt = \olbl \gtcolon \gttry \gtobrc \ostmts_1 \gtcbrc \gtexcept \omemvariable \gtobrc \ostmts_2 \gtcbrc \gtsemi \\
      \ostmts_1 = [\ostmt_1, \ldots]
    }{
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\ostmt_1, \gtime + 1}}
    }
  ...
  \begin{mathpar}
    \relationRule{Raise Exception}{
      \gnode_1 \gsBeforeIn \gnode_2 \\
      \gnode_2 = \gsLR{\ostmt, \gtime}\\
      \ostmt = \olbl \gtcolon \gtraise \omemvariable \gtsemi
    }{
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsraise, \gtime + 1}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Advance While Loop}{
      \gnode_1 \gsBeforeIn \gnode_2 \\
      \gnode_2 = \gsLR{\gsadvance, \gtime}\\
  ...
  \begin{mathpar}
    \relationRule{Return}{
      \gnode_1 \gsBeforeIn \gnode_2 \\
      \gnode_2 = \gsLR{\gsreturn, \gtime}\\
      \ostmt \osUnder \ostmt' \\
      \ostmt' \text{ is a funcdef} \\
      \ostmt_1 \osStartof \ostmt' \\
      \gsLR{\ostmt_0, \gtime''} \gsBefore \gsLR{\ostmt_1.\gtime'} \\
      \ostmt_0 \osBefore \ostmt'_1 \\
    }{
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\ostmt'_1, \gtime + 1}}
    }
  \end{mathpar}
  ...
  \begin{mathpar}
    \relationRule{Raise Pop}{
      ...
      \gsAddEdge{\gnode_2 \gsBefore \gsLR{\gsraise[_0], \gtime + 1}}
    }
  \end{mathpar}
