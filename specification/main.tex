  ...
  \begin{definition}[Lookup]
    ...
    \begin{enumerate}%[label=(\alph*)]
      ...
      \begin{enumerate}[label=(\alph*)]
        ...
        \item \rulename{Isint Rule \ovalue}
        If $\lstack = [\lInstr{Isint}, \ovalue] \listConcat \lstack'$, and
           \begin{flalign*}
             \ovalue' =
             \begin{cases}
               \ostrue, & \text{if } \ovalue \in \mathbb{Z} \\
               \osfalse, & \text{if } \ovalue \notin \mathbb{Z},
             \end{cases}
           \end{flalign*}
        then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1, [\ovalue] \listConcat \lstack')$.

        \item \rulename{Isbool Rule \ovalue}
        If $\lstack = [\lInstr{Isbool}, \ovalue] \listConcat \lstack'$, and
           \begin{flalign*}
             \ovalue' =
             \begin{cases}
               \ostrue, & \text{if } \ovalue \in \mathbb{B} \\
               \osfalse, & \text{if } \ovalue \notin \mathbb{B},
             \end{cases}
           \end{flalign*}
        then \formalRuleLine $\lresults \supseteq \osFunc{Lookup}(\ggraph, \gnode_1, [\ovalue] \listConcat \lstack')$.
