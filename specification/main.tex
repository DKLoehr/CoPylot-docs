...
\begin{document}
  ...
  \begin{grammar}
    ...
    \grule[abstract lists]{\olst_{\otype}}{
  ...
  \begin{mathpar}
    \relationRule{Index}{
      \ovalue_1 = \oheap[\ovalvariable_1] = [\omem_0, \ldots, \omem_n] \\
  ...
  \end{mathpar}
    ...
    \begin{mathpar}
    \relationRule{Index (abstract)}{
      \ovalue_1 = \oheap[\ovalvariable_1] = \olst_{\otype} \\
      \ovalue_2 = \{\ovalue \;|\; \ovalue \text{ is a value of type } \in \otype\} \\
  ...
  \begin{mathpar}
    \relationRule{Slice (abstract)}{ % TODO: how to address error
      \ovalue = \oheap[\ovalvariable'] = \olst_{\otype} \\ % TODO: of the same type
      \ovalue' = \olst'_{\otype} \\
      \oheap' = \oheap[\ovalvariable \mapsto \ovalue]
    }{
      [\gtlet \ovalvariable \gteq \ovalvariable' \gtobrk \ovalvariable_1 \gtcolon \ovalvariable_2 \gtcbrk \gtsemi] \listConcat \otstmts, \oheap \osTransition
  ...
  \begin{mathpar}
    \relationRule{List Concatenation (within bound)}{
      \ovalue_1 = \oheap[\ovalvariable_1] = [\omem_1, \ldots, \omem_i]_n \\
      \ovalue_2 = \oheap[\ovalvariable_2] = [\omem_1', \ldots, \omem_j']_n\\
      i+j \leq n \\
      \ovalue = [\omem_1, \ldots, \omem_i, \omem_1', \ldots, \omem_j']_n \\
      \oheap' = \oheap[\ovalvariable \mapsto \ovalue]
    }{
  ...
  \begin{mathpar}
    \relationRule{List Concatenation (out of bound)}{
      ...
      \ovalue_2 = \oheap[\ovalvariable_2] = [\omem_1', \ldots, \omem_j']_n\\
      i+j > n \\
      \otype = \text{ the set of types involved in }\ovalue_1, \ovalue_2 \\
      \ovalue = \olst_{\otype} \\
      \oheap' = \oheap[\ovalvariable \mapsto \ovalue]
    }{
      [\gtlet \ovalvariable \gteq \ovalvariable_1 \gtlstconcat \ovalvariable_2 \gtsemi] \listConcat \otstmts, \oheap \osTransition
  ...
  \begin{mathpar}
    \relationRule{List Concatenation (one is abstract)}{
      \ovalue_1 = \olst_{\otype} \\
      \ovalue_2 = [\omem_1, \ldots, \omem_n] \text{ or vice versa }\\
      \otype' = \text{ the set of types involved in }\ovalue_2 \\
      \ovalue = \olst''_{\otype \cup \otype'} \\
      \oheap' = \oheap[\ovalvariable \mapsto \ovalue]
    }{
      [\gtlet \ovalvariable \gteq \ovalvariable_1 \gtlstconcat \ovalvariable_2 \gtsemi] \listConcat \otstmts, \oheap \osTransition
      \otstmts, \oheap'
  ...
  \begin{mathpar}
    \relationRule{List Concatenation (abstract)}{
      \ovalue_1 = \olst_{\otype} \\
      \ovalue_2 = \olst'_{\otype'}\\
      \ovalue = \olst''_{\otype \cup \otype'} \\
      \oheap' = \oheap[\ovalvariable \mapsto \ovalue]
    }{
      [\gtlet \ovalvariable \gteq \ovalvariable_1 \gtlstconcat \ovalvariable_2 \gtsemi] \listConcat \otstmts, \oheap \osTransition
