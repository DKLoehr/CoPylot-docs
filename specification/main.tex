        ...
        \begin{figure}\center
              \begin{grammar}
                ...
                \grule[directives]{\odirective}{
                    ...
                    \gor    def \quad \ovariable(\ovariable,\ldots) \gteq \{ \oprogram \}
                            % def x(x, ...) = {S}
                    \gor    return \quad \ovariable % return x
                ...
                \grule[values]{\ovalue}{
                            \mathbb{Z}
                    \gor    \langle \opscope,\ofunc(\ovariable) \ofuncarr \oprogram \rangle % < eta, fun(x) -> S >
                    \gor    [\omem, \ldots] % [m, ...]
                    \gor    (\omem, \ldots) % (m, ...)
                }
                % expressions
              ...
              \relationRule{Name Assignment}{
                  ...
                  \omem \gteq \osLookup (\opscope,\oparent,\oenv,\ovariable_2)\\
                  \obinding \gteq \oenv(\opscope) \\
              ...
              \relationRule{List Assignment}{
                  ...
                  \forall i \in \{1,\ldots,n\}, \omem_i \gteq \osLookup(\opscope,\oparent,\oenv,\ovariable_i) \\
              ...
              \relationRule{Function Definition}{
                  \oprogram(\olbl) \gteq \olbl:\olbl': def \quad \ovariable_1(\ovariable_2) \gteq \{\oprogram\} \\
                  \ovalue \gteq \langle \eta, \ofunc(\ovariable_2) \ofuncarr \oprogram \rangle \\
                  \oheap' \gteq \oheap[\omem \mapsto \ovalue] \\
                  \omem \notin \oheap \\
                  \obinding \gteq \oenv(\opscope) \\
                  \obinding' \gteq \obinding[\ovariable_1 \mapsto \omem] \\
                  ...
                  % TODO: multiargs
                      ...
                      \opscope'' \notin \oenv \\
                      \omem' \gteq \osLookup (\opscope,\oparent,\oenv,\ovariable_3) \\
            ...
            \begin{figure}\center
              ...
              \relationRule{Return}{
                  \oprogram(\olbl) \gteq \olbl:\olbl' : return \\
                  \ostack \gteq [\ostackframe,\langle \olbl'',\oprogram' \rangle] \listConcat \ostack' \\
                  \opscope' \gteq \oparent[\opscope] \\
                  \olbl'' \osBefore{S'} \olbl''' \\
              }{
                  [\ostackframe,\langle \olbl'',\oprogram' \rangle] \listConcat \ostack,\oheap,\oenv,\oparent,\opscope \osTransition
                  [\langle \olbl'',\oprogram' \rangle] \listConcat \ostack',\oheap,\oenv,\oparent,\opscope'
              }

              % TODO: fix format here
              \relationRule{Return with Arguments}{
                  \oprogram(\olbl) \gteq \olbl:\olbl' : return \ovariable \\
                  \ostack \gteq [\ostackframe,\langle \olbl'',\oprogram' \rangle] \listConcat \ostack' \\
                  \omem \gteq \osLookup(\opscope,\oparent,\oenv,\ovariable) \\
              ...
              \relationRule{End of Function}{
                  ...
                  [\langle \osend,\oprogram \rangle,\langle \olbl,\oprogram' \rangle] \listConcat \ostack,\oheap,\oenv,\oparent,\opscope \osTransition
                  [\langle \olbl',\oprogram' \rangle] \listConcat \ostack',\oheap,\oenv,\oparent,\opscope'
              }
              ...
              \relationRule{End of Program}{
                  ...
                  \ostack,\oheap,\oenv,\oparent,\opscope \osTransition
                  [],\oheap,\oenv,\oparent,\opscope'
              }
